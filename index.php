    ...
    <div class="carousel-item active">
      <div class="row">
          <div class="col-md-6">
            ...
            <div class="image_1"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-1.png"></div>
          </div>
          <div class="col-md-6">
    ...
    <div class="carousel-item">
      <div class="row">
          <div class="col-md-6">
            ...
            <div class="image_1"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-1.png"></d  iv>
          </div>
          <div class="col-md-6">
            <h1 class="booking_text">Book a City Taxi to your destination in town</h1>
            <div class="contact_bg">
    ...
    <div class="carousel-item">
      <div class="row">
          <div class="col-md-6">
            ...
            <div class="image_1"><img src="../PRG5_20221_UTSP_0320210027/assets/images/car.png"></div>
          </div>
          <div class="col-md-6">
            <h1 class="booking_text">Book a City Taxi to your destination in town</h1>
            <div class="contact_bg">
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="taxi_main">
                ...
                distracted </p>
                <div class="images_2"><a href="#"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-2.png"></a></div>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="taxi_main">
                ...
                <p class="reader_text">act that a reader will be<br> 
                distracted </p>
                <div class="images_2"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-2.png"></a></div>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="taxi_main">
    ...
    <div class="ride_section_2 layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <div class="image_3"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-3.png"></div>
          </div>
          <div class="col-sm-8">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="image_3"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-4.png"></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            <div class="image_3"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-5.png"></div>
          </div>
          <div class="col-sm-8">
            <h1 class="cabe_text">Uloax for Every Pocket</h1>
            <p class="long_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as It is a long established fact that a reader will be distracted by the readable c</p>
      ...
      <div class="container-fluid">
        <div class="location_main">
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="image_7"><img src="../PRG5_20221_UTSP_0320210027/assets/images/img-7.png"></div>
            </div>
          </div>
        </div>
      </div>
